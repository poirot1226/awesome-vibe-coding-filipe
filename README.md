...
- [NextReset](https://nextreset.ai/) - Free browser companion for Codex with source-linked public reset history, official AI-service incident updates, and a personal allowance timer stored locally in the browser.
