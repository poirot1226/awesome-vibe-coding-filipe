...
- [NextReset](https://nextreset.ai/) - Free browser companion for Claude Code with source-linked reset history, official incident updates, and a personal reset timer stored locally in the browser.
